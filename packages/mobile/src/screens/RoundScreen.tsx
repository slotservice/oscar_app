  ...
  const navigateToSection = (section: SectionItem) => {
    switch (section.type) {
      case 'checklist':
        ...
        break;
      case 'labs':
        navigation.navigate('LabEntry', { roundId });
        break;
      case 'observations':
        navigation.navigate('Observations', { roundId });
        break;
      case 'suggestions':
        navigation.navigate('Suggestions', { roundId });
        break;
      case 'issues':
        navigation.navigate('Issues', { roundId });
        break;
      case 'summary':
        navigation.navigate('Summary', { roundId });
        break;
    }
  };
